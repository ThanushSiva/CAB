...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		"`availability`.`id`" => "id",
		"IF(    CHAR_LENGTH(`buses1`.`number`), CONCAT_WS('',   `buses1`.`number`), '') /* Car */" => "bus",
	...
	$x->QueryFieldsFilters = array(   
		"`availability`.`id`" => "ID",
		"IF(    CHAR_LENGTH(`buses1`.`number`), CONCAT_WS('',   `buses1`.`number`), '') /* Car */" => "Car",
		"IF(    CHAR_LENGTH(`routes1`.`name`) || CHAR_LENGTH(`routes1`.`time`), CONCAT_WS('',   `routes1`.`name`, '  :', `routes1`.`time`), '') /* Route */" => "Route",
		"IF(    CHAR_LENGTH(`routes1`.`amount`), CONCAT_WS('',   `routes1`.`amount`), '') /* Amount */" => "Amount",
	...
	$x->filterers = array(  'bus' => 'Car', 'route' => 'Route');
	...
	$x->ColCaption = array("Car", "Route", "Amount", "Date", "Departure Time", "Status");
